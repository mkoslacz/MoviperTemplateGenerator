...
<recipe>
    ...
    <#if packagesPerUseCase>
        ...
        <instantiate from="root/src/app_package/AggregateItem.java.ftl"
                      to="${aggregatesOut}/${aggregateName}Item.java" />
        ...
        <instantiate from="root/src/app_package/Interactor.java.ftl"
                       to="${viewHolderCompontentsOut}/${prefix}Interactor.java" />

        <instantiate from="root/src/app_package/Presenter.java.ftl"
                       to="${viewHolderCompontentsOut}/${prefix}Presenter.java" />
        ...
        <#if createEntity>
            ...
            <instantiate from="root/src/app_package/with_entity/PrefixedAggregateItem.java.ftl"
                           to="${aggregatesOut}/${prefix}${aggregateName}Item.java" />

            <instantiate from="root/src/app_package/with_entity/ViewHolder.java.ftl"
                           to="${viewHolderCompontentsOut}/${prefix}ViewHolder.java" />
        <#else>
        ...
        <#if createDelegate>
            <instantiate from="root/src/app_package/AdapterDelegate.java.ftl"
                         	to="${delegatesOut}/${prefix}AdapterDelegate.java" />
        </#if>


        <#if createViewHelper>    
            <instantiate from="root/src/app_package/ViewHelperContract.java.ftl"
            		   	        to="${viewHolderCompontentsOut}/${prefix}Contract.java" />

            <instantiate from="root/src/app_package/ViewHelperRouting.java.ftl"
                           to="${viewHolderCompontentsOut}/${prefix}Routing.java" />
        <#else>
        ...
        <open file="${viewHolderCompontentsOut}/${prefix}Contract.java" />
